            ...
            {data.length > 0 &&
                data.map((project) => {
                    ...
                    if (data.indexOf(project) === 1) {
                        return (
                            <>
                                <div key={project?.project_info_id} className={` text-white z-30 h-fit w-1/2 md:text-black md:bg-slate-300 p-4 duration-1000 cursor-pointer hover:scale-105 transition-all`} >
